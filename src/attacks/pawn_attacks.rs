...
impl PawnsAttacks {
    pub const ATTACK_TABLE: [[Bitboard; 64]; 2] = {
        ...
        while square_index < 64 {
            ...
            result[Side::WHITE.get_value() as usize][square_index] = Bitboard::from_raw(attack_map);
            attack_map = 0;
            ...
            result[Side::BLACK.get_value() as usize][square_index] = Bitboard::from_raw(attack_map);
            square_index += 1;
        }
        result
    };
